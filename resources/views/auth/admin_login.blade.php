...
<head>
  <meta charset="utf-8">
    ...
    <title>Spes eCommerce Admin - Log in </title>
                        ...
                        @csrf
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input id="email" type="email" name="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="E-mail">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
