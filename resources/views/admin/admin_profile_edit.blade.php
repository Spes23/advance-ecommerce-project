                        ...
                        <div class="row">
                            <div class="col-12">	
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <h5>Admin User Name Field <span class="text-danger">*</span></h5>
                                            <div class="controls">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <h5>Admin E-mail Field <span class="text-danger">*</span></h5>
                                            <div class="controls">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <h5>Profile Image Field <span class="text-danger">*</span></h5>
                                            <div class="controls">
